...
const evaluator =[{accuracy: 75, eval: "excellent"},
...
console.log(value[0].eval)
  return (
    <Card className='md:col-span-7 mt-4'>
        ...
        <div 
        className='flex flex-col text-2xl font-semibold text-yellow-400'>
            <span>{value[0].eval}</span>
            <span
            className='text-sm text-center text-black capacity-50'
            >{value[0].accuracy} accuracy</span>
        </div>
